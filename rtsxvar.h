/* Based on OpenBSD's rtsxvar.h, but struct rtsx_softc adjusted for FreeBSD */
...
struct rtsz_softc {
	...
	struct resource *pci_mem_res; /* PCI memory resource */
	/* TODO I can use the newer API that gets the resource instead of iot and ioh and then I should remove the two */
